var SCREENS = {
	...
	"help_me": {
		...
		"answers":		[
			{
				"text":		"Настоятельно рекомендую вам ознакомиться с основами арбитража. Почитайте профильные форумы, блоги, паблики и изучите информацию в интернете. Можете начать с conversion.im",
